...
#include "CarlaIRCameraPublisher.h"
...
namespace ros2 {
  ...
  bool CarlaIRCameraPublisher::HasBeenInitialized() const {
    return _impl_info->_init;
  }

  float CarlaIRCameraPublisher::GetFov() const {
    return _fov;
  }

  void CarlaIRCameraPublisher::InitInfoData(uint32_t x_offset, uint32_t y_offset, uint32_t height, uint32_t width, float fov, bool do_rectify) {
  ...
  bool CarlaIRCameraPublisher::Init() {
    return InitImage() && InitInfo();
  }

  bool CarlaIRCameraPublisher::InitImage() {
  ...
  bool CarlaIRCameraPublisher::InitInfo() {
  ...
  bool CarlaIRCameraPublisher::Publish() {
    return PublishImage() && PublishInfo();
  }

  bool CarlaIRCameraPublisher::PublishImage() {
  ...
  bool CarlaIRCameraPublisher::PublishInfo() {
    eprosima::fastrtps::rtps::InstanceHandle_t instance_handle;
  ...
  void CarlaIRCameraPublisher::SetImageData(int32_t seconds, uint32_t nanoseconds, size_t height, size_t width, const uint8_t* data) {
  ...
  void CarlaIRCameraPublisher::SetInfoRegionOfInterest( uint32_t x_offset, uint32_t y_offset, uint32_t height, uint32_t width, bool do_rectify) {
  ...
  void CarlaIRCameraPublisher::SetData(int32_t seconds, uint32_t nanoseconds, size_t height, size_t width, std::vector<uint8_t>&& data) {
    ...
    _impl->_image.encoding("bgra8");  // IR thermal data encoded as BGRA
    _impl->_image.is_bigendian(0);
    _impl->_image.step(_impl->_image.width() * sizeof(uint8_t) * 4);
    _impl->_image.data(std::move(data));
  }

  void CarlaIRCameraPublisher::SetCameraInfoData(int32_t seconds, uint32_t nanoseconds) {
    builtin_interfaces::msg::Time time;
    time.sec(seconds);
    time.nanosec(nanoseconds);
  ...
  CarlaIRCameraPublisher::CarlaIRCameraPublisher(const char* ros_name, const char* parent) :
  _impl(std::make_shared<CarlaIRCameraPublisherImpl>()),
  ...
  CarlaIRCameraPublisher::CarlaIRCameraPublisher(const CarlaIRCameraPublisher& other) {
  ...
  CarlaIRCameraPublisher& CarlaIRCameraPublisher::operator=(const CarlaIRCameraPublisher& other) {
    _frame_id = other._frame_id;
    _name = other._name;
    _parent = other._parent;
    _impl = other._impl;
  ...
  CarlaIRCameraPublisher::CarlaIRCameraPublisher(CarlaIRCameraPublisher&& other) {
  ...
  CarlaIRCameraPublisher& CarlaIRCameraPublisher::operator=(CarlaIRCameraPublisher&& other) {
    _frame_id = std::move(other._frame_id);
    _name = std::move(other._name);
    _parent = std::move(other._parent);
    _impl = std::move(other._impl);
